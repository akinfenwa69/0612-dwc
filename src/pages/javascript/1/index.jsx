    ...
    return (
        <div className="grid gap-5">
            ...
            <div className="card-header grid text-center gap-3">
                <h1 className="text-5xl">Introducció</h1>
                <p className="text-muted-foreground">Mostra el nom i cognom/s</p>
            </div>
            ...
            <div className="card-content grid gap-3">
                ...
                <button
                    onClick={() => handleAlert()}
                    className="border border-border hover:bg-accent rounded-lg p-3 cursor-pointer"
                >
                    SUBMIT
                </button>
            </div>
